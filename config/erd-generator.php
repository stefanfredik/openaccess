...
return [
    ...
    'directories' => [
        ...
        base_path('Modules/ActiveDevice/app/Models'),
        base_path('Modules/PassiveDevice/app/Models'),
        base_path('Modules/Company/app/Models'),
        base_path('Modules/Area/app/Models'),
        base_path('Modules/Pop/app/Models'),
        base_path('Modules/Site/app/Models'),
        base_path('Modules/Server/app/Models'),
        base_path('Modules/Cpe/app/Models'),
    ],
