    ...
    <div :class="cn('w-full', props.class)">
            ...
            :class="
                cn(
                    ...
                    isDragging
                        ...
                        : 'border-emerald-400 hover:bg-emerald-50/10',
        ...
        >
            ...
            <div
                ...
                class="group relative flex h-full w-full items-center justify-center p-2"
            >
                <img
                    v-if="previewUrl"
                    :src="previewUrl"
                ...
                <div v-else class="flex flex-col items-center">
                    ...
                    >
                    <span class="text-xs text-gray-500" v-if="modelValue"
                        >({{ (modelValue.size / 1024).toFixed(1) }} KB)</span
                    >
                </div>
            ...
            >
                ...
                <p v-else class="text-xs text-gray-500 dark:text-gray-400">
                    Format: PNG, JPG& Max size: {{ maxSize || 5 }} MB
                </p>
            </div>
        </div>
