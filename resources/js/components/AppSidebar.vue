    ...
    <SidebarContent class="scrollbar-thin px-2">
      ...
      <template v-if="!isSuperAdmin && isInPendataanScope">
        <SidebarGroup class="px-2 py-0">
          <!-- Inventory Label -->
          <div class="mb-3 flex h-8 items-center gap-2 px-2 text-sm font-medium text-foreground">
          ...
          <div class="space-y-3">
            ...
            <div class="space-y-1 rounded-lg bg-muted/40 px-2 py-2 dark:bg-muted/20">
              <div class="flex items-center gap-2 px-2 py-1 text-[9px] font-bold text-muted-foreground/60 uppercase">
      ...
      <div v-if="shouldShowManagement" class="mt-6 border-t border-border/50 pt-4">
        <div v-if="isSuperAdmin" class="px-4 py-2 text-[10px] font-black tracking-[0.2em] text-muted-foreground/50 uppercase">
          Administrasi Sistem
        </div>
