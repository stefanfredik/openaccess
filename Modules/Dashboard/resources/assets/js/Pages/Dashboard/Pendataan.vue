<script setup lang="ts">
  ...
  import { Activity, Clock, Component, Cpu, Database, HardDrive, Layers, MapPin, Network, Settings2 } from 'lucide-vue-next'
...
<template>
  ...
  <AppLayout
    ...
    <div class="mx-auto w-full max-w-[1600px] space-y-10 p-6 md:p-10">
      <!-- Hero Header -->
      <div class="relative overflow-hidden rounded-[2.5rem] bg-slate-950 p-8 text-white shadow-2xl md:p-12">
        ...
        <div class="relative z-10 flex flex-col items-center justify-between gap-8 md:flex-row">
          <div class="space-y-4 text-center md:text-left">
            ...
            <h1 class="text-4xl font-black tracking-tighter md:text-5xl">
              Ringkasan Data
              <span class="text-primary">Aset Jaringan</span>
            </h1>
            <p class="max-w-2xl text-lg leading-relaxed text-slate-400">Pantau jumlah distribusi perangkat dan infrastruktur secara real-time.</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-6">
        <Link v-for="card in summaryCards" :key="card.title" :href="route(card.link)" class="group">
          <Card
            ...
            <CardContent class="flex flex-col items-center gap-4 p-6 text-center">
              ...
              <div>
                <div class="mb-1 text-3xl leading-none font-black tracking-tighter text-slate-900">
                  {{ card.count }}
                </div>
      ...
      <div class="grid grid-cols-1 items-start gap-8 lg:grid-cols-12">
        ...
        <div class="space-y-8 lg:col-span-8">
          <div class="flex items-center justify-between px-2">
            <h2 class="flex items-center gap-3 text-2xl font-black tracking-tight">
          ...
          <div class="grid gap-6 md:grid-cols-1">
            <Card
              ...
              <CardContent class="flex flex-col p-0 md:flex-row">
                <div :class="module.color" class="z-10 w-full md:w-3"></div>
                <div class="flex flex-grow flex-col items-center gap-8 p-8 md:flex-row">
                  <div
                  ...
                  <div class="flex-grow space-y-0.5 text-center md:text-left">
                  ...
                  <div class="grid w-full grid-cols-2 gap-3 sm:grid-cols-3 md:w-auto">
                    <Link v-for="item in module.items" :key="item.name" :href="route(item.href)" class="group/item">
                      <div
                        ...
                        <div class="truncate text-[10px] font-bold tracking-tight text-slate-800 transition-colors group-hover/item:text-primary">
                          {{ item.name }}
                        </div>
        ...
        <div class="space-y-8 lg:col-span-4">
          <Card class="overflow-hidden rounded-[2rem] border-none bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <CardHeader class="pb-4">
              <CardTitle class="flex items-center gap-2 text-xl font-black tracking-tight">
              ...
              <div class="space-y-0 text-sm">
                <div
                  ...
                  <div class="min-w-0 flex-grow">
                    ...
                    <div class="mt-0.5 flex items-center justify-between text-[10px] font-bold tracking-tighter text-slate-400 uppercase">
                      <span>{{ act.user }}</span>
                      <span>{{ act.time }}</span>
                    </div>
                  </div>
          ...
          <div
            ...
            <div class="relative z-10 space-y-4 text-center">
              ...
              <p class="text-xs leading-relaxed text-indigo-100 opacity-80">Kelola visualisasi aset Anda langsung melalui peta interaktif.</p>
              <Link :href="route('map.index')" class="block">
                <Button class="h-11 w-full rounded-xl bg-white font-bold text-primary transition-all hover:bg-indigo-50"> Buka GIS Map </Button>
              </Link>
            </div>
          </div>
        </div>
