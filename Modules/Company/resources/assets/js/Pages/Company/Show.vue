            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                <Card class="md:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription
                            >Basic details about the company.</CardDescription
                        >
                    </CardHeader>
                    <CardContent class="grid gap-6">
                        <div class="flex items-start gap-4">
                            <div
                                class="flex h-24 w-24 flex-shrink-0 items-center justify-center overflow-hidden rounded-lg border bg-muted"
                            >
                                <img
                                    v-if="company.logo"
                        ...
                        >
                            ...
                            <div class="space-y-3">
                                ...
                                <div
                                    class="pl-6 text-sm leading-relaxed whitespace-pre-wrap"
                                >
                                    {{ company.address }}
                                </div>
                            </div>
