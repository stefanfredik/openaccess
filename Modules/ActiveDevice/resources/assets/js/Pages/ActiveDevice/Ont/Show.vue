<script setup lang="ts">
  ...
  import OntOverview from '@/../../Modules/ActiveDevice/resources/assets/js/Components/OntOverview.vue'
  ...
  <AppLayout
    ...
    <div class="max-w-7xl space-y-6 p-4 md:p-6">
      ...
      <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div class="space-y-1">
          ...
          <p class="flex items-center gap-2 text-sm text-muted-foreground">
            <span class="rounded bg-muted px-1.5 py-0.5 font-mono text-[10px] uppercase">{{ ont.code }}</span>
            <span>&bull;</span>
            <span>{{ ont.brand }} {{ ont.model }} ({{ ont.onu_type }})</span>
          </p>
        </div>
      ...
      <div class="flex flex-col space-y-8 md:hidden">
        ...
        <!-- Service Ports -->
        <ServicePortsManager :device="ont" device-type="Modules\ActiveDevice\Models\Ont" />
