<script setup lang="ts">
  ...
  const form = useForm({
    ...
    service_ports: props.ont.service_ports || [],
  })
    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-muted-foreground">Update Optical Network Terminal device details.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Update device details for {{ ont.name }}. </CardDescription>
          </CardHeader>
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 border-t p-6">
            <Button variant="outline" as-child>
              <Link :href="route('active-device.ont.index')">Cancel</Link>
            </Button>
