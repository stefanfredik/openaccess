...
const selectedOnt = computed(() => {
    return (
        props.onts.data.find((o: any) => o.id === selectedOntId.value) || null
    );
});
            ...
            <Sheet :open="isDrawerOpen" @update:open="isDrawerOpen = $event">
                ...
                >
                    <SheetHeader class="sr-only">
                        <SheetTitle
                            >Detail ONT: {{ selectedOnt?.name }}</SheetTitle
                        >
                        <SheetDescription
