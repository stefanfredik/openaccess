  ...
  <AppLayout
    ...
    <div class="flex max-w-4xl flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold tracking-tight">Add Router</h1>
          <p class="text-muted-foreground">Register a new IP Router.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Basic device identification and network details. </CardDescription>
          </CardHeader>
          <CardContent class="grid gap-6">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div class="space-y-1.5">
                ...
                <FileUploader v-model="form.photo" accept="image/png, image/jpeg, image/jpg" :max-size="2" :error="form.errors.photo" />
              </div>
            </div>
