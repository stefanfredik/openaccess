      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Update device details for {{ router.name }}. </CardDescription>
          </CardHeader>
          <CardContent class="grid gap-6">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div class="space-y-2">
                ...
                <Input id="password" type="password" v-model="form.password" placeholder="•••••••• (leave empty to keep current)" />
                <p class="text-[10px] text-muted-foreground">Fill this only if you want to update the device password.</p>
              </div>
            </div>
            <MapLocationPicker
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div class="space-y-2">
                ...
                <Input id="purchase_year" type="number" v-model="form.purchase_year" :min="1900" :max="new Date().getFullYear()" />
              </div>
              <div class="space-y-1.5">
                ...
                <FileUploader
                  ...
                  :initial-image="router.photo ? '/storage/' + router.photo : null" />
              </div>
            </div>
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 border-t p-6">
            <Button variant="outline" as-child>
              <Link :href="route('active-device.router.index')">Cancel</Link>
            </Button>
