  ...
  <AppLayout
    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold tracking-tight">Edit Access Point</h1>
          <p class="text-muted-foreground">Update Wireless Radio / Access Point details.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Update device details for {{ accessPoint.name }}. </CardDescription>
          </CardHeader>
