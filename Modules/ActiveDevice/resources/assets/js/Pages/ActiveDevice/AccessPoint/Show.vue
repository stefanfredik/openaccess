...
const form = useForm({
    portable_id: props.accessPoint.id,
    portable_type: 'Modules\\ActiveDevice\\Models\\AccessPoint',
    name: '',
    port: '',
    status: 'Active',
});
                        ...
                        <div class="overflow-hidden rounded-md border">
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y">
                                    <tr
                                        v-for="port in accessPoint.service_ports"
                                        :key="port.id"
                                    ...
                                    <tr
                                        v-if="
                                            !accessPoint.service_ports?.length
                                        "
                                    >
                                        <td
                                            colspan="4"
