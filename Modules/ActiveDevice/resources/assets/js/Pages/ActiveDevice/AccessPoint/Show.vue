  ...
  <AppLayout
    ...
    <div class="max-w-7xl space-y-6 p-4 md:p-6">
      ...
      <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div class="space-y-1">
          ...
          <p class="flex items-center gap-2 text-sm text-muted-foreground">
            <span class="rounded bg-muted px-1.5 py-0.5 font-mono text-[10px] uppercase">{{ accessPoint.code }}</span>
            <span>&bull;</span>
            <span>{{ accessPoint.brand }} {{ accessPoint.model }}</span>
          </p>
        </div>
        <div class="flex items-center gap-2">
          ...
          <Button size="sm" as-child>
            <Link :href="route('active-device.access-point.edit', accessPoint.id)">
      ...
      <div class="flex flex-col space-y-8 md:hidden">
        ...
        <!-- Service Ports -->
        <ServicePortsManager :device="accessPoint" device-type="Modules\ActiveDevice\Models\AccessPoint" />
