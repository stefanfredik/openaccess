<script setup lang="ts">
  ...
  const submit = () => {
    form.post(route('active-device.access-point.store'))
  }
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Basic device identification and wireless details. </CardDescription>
          </CardHeader>
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 border-t p-6">
            <Button variant="outline" as-child>
              <Link :href="route('active-device.access-point.index')">Cancel</Link>
            </Button>
