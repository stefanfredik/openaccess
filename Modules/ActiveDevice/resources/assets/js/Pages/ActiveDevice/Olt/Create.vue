...
const submit = () => {
    form.post('/pendataan/active-devices/olt');
};
    ...
    <AppLayout :breadcrumbs="[
        ...
        <div class="max-w-4xl mx-4 p-4 md:p-4 space-y-6">
            ...
            <div class="space-y-1">
                ...
                <p class="text-muted-foreground text-sm text-foreground/60">Silahkan lengkapi data perangkat OLT dibawah ini.</p>
            </div>
                ...
                <Card class="border shadow-none">
                    ...
                    <CardFooter class="border-t bg-slate-50/50 p-6 flex justify-end gap-3 rounded-b-lg">
                        <Button variant="ghost" as-child class="font-medium">
                            <Link href="/active-devices/olt">Batal</Link>
                        </Button>
