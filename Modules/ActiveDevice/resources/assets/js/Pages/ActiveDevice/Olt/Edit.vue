  ...
  <AppLayout
    ...
    <div class="mx-4 max-w-4xl space-y-6 p-4 md:p-4">
      ...
      <div class="space-y-1">
        ...
        <p class="text-sm text-foreground/60 text-muted-foreground">Perbarui informasi perangkat OLT.</p>
      </div>
          ...
          <CardContent class="grid gap-5">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div class="space-y-1.5">
                ...
                <div v-if="form.errors.infrastructure_area_id" class="mt-1 text-xs text-destructive">
              ...
              <div class="space-y-1.5">
                ...
                <div v-if="form.errors.pop_id" class="mt-1 text-xs text-destructive">
                  {{ form.errors.pop_id }}
                </div>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div class="space-y-1.5">
                ...
                <Select v-model="form.pon_type">
                  <SelectTrigger class="h-11 w-full rounded-lg border-slate-200">
          ...
          <CardContent class="grid gap-5">
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
              <div class="space-y-1.5">
                ...
                <div v-if="form.errors.ip_address" class="mt-1 text-xs text-destructive">
        ...
        <Card class="border shadow-none">
          <CardHeader class="pb-4">
            <div class="flex items-center justify-between">
              <div>
                <CardTitle class="text-base font-semibold">Service Ports</CardTitle>
                <CardDescription class="text-xs">Daftar port layanan aktif pada perangkat.</CardDescription>
              </div>
              <Button type="button" variant="outline" size="sm" @click="addServicePort"> <Plus class="mr-2 h-4 w-4" /> Tambah Port </Button>
            </div>
          </CardHeader>
          <CardContent class="grid gap-4">
            <div
              ...
              <div class="col-span-4 space-y-1.5">
                ...
                <Input v-model="sp.name" placeholder="e.g. SSH" class="h-10 bg-white" />
              </div>
              <div class="col-span-3 space-y-1.5">
                <Label class="text-xs">Port</Label>
                <Input type="number" v-model="sp.port" placeholder="22" class="h-10 bg-white" />
              </div>
              <div class="col-span-3 space-y-1.5">
            ...
            <div v-if="!form.service_ports.length" class="py-4 text-center text-sm text-muted-foreground italic">
        ...
        <Card class="border shadow-none">
          ...
          <CardContent class="grid gap-5">
            ...
            <div class="space-y-1.5">
              ...
              <Textarea id="description" v-model="form.description" class="min-h-[100px] resize-none rounded-lg border-slate-200" />
            </div>
          ...
          <CardFooter class="flex justify-end gap-3 rounded-b-lg border-t bg-slate-50/50 p-6">
            <Button variant="outline" as-child>
              <Link :href="route('active-device.olt.index')">Batal</Link>
            </Button>
      ...
      <Card class="border shadow-none">
        <CardHeader class="pb-4">
          <CardTitle class="text-base font-semibold">Physical Interfaces</CardTitle>
          <CardDescription class="text-xs">Kelola port fisik dan status operasional perangkat.</CardDescription>
        </CardHeader>
        <CardContent>
          <InterfaceManager :device-id="olt.id" :device-type="'Modules\\ActiveDevice\\Models\\Olt'" :interfaces="olt.interfaces || []" />
        </CardContent>
      </Card>
    </div>
  </AppLayout>
