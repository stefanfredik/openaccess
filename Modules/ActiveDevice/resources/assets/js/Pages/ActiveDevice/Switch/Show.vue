...
const form = useForm({
    portable_id: props.networkSwitch.id,
    portable_type: 'Modules\\ActiveDevice\\Models\\AdSwitch',
    name: '',
    port: '',
    status: 'Active',
});
                        ...
                        <div class="overflow-hidden rounded-md border">
                            <table class="w-full text-sm">
                                ...
                                <tbody class="divide-y">
                                    <tr
                                        v-for="port in networkSwitch.service_ports"
                                        :key="port.id"
                                    ...
                                    <tr
                                        v-if="
                                            !networkSwitch.service_ports?.length
                                        "
                                    >
                                        <td
                                            colspan="4"
