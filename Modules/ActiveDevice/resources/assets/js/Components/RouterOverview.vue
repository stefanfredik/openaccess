          ...
          <div class="mb-6 grid grid-cols-2 gap-6 md:grid-cols-4">
            <div class="space-y-1">
              ...
              <div class="flex items-center gap-2">
                <div class="h-2.5 w-2.5 rounded-full" :class="router.is_active ? 'bg-green-500' : 'bg-red-500'"></div>
                <span class="font-medium">{{ router.is_active ? 'Active' : 'Inactive' }}</span>
              </div>
            </div>
            <div class="space-y-1">
            ...
            <div class="space-y-1">
              ...
              <div class="font-medium">{{ router.port_count }} Ports</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <CardContent>
        <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
          <div class="space-y-1">
            ...
            <div class="font-medium">{{ router.brand }} {{ router.model }}</div>
          </div>
          <div class="space-y-1">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <div class="space-y-1">
            ...
            <div class="flex items-center gap-2 font-mono text-sm">
              <span>{{ router.latitude || '0' }}, {{ router.longitude || '0' }}</span>
              <a
                v-if="router.latitude && router.longitude"
    ...
    <Card>
      ...
      <CardContent>
        <p class="text-sm leading-relaxed text-foreground/80">
          {{ router.description || 'Tidak ada keterangan tambahan.' }}
        </p>
      </CardContent>
    </Card>
  </div>
