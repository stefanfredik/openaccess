      ...
      <div class="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <div class="pointer-events-none">
              <LocationPicker :latitude="pop.latitude" :longitude="pop.longitude" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div v-else class="flex items-center justify-center h-48 bg-muted rounded-md text-muted-foreground">No photos available</div>
          </CardContent>
        </Card>
      </div>
    </div>
