<script setup lang="ts">
  ...
  import { edit as popEdit, index as popIndex, update as popUpdate } from '@/routes/pop'
  ...
  <AppLayout
    ...
    <div class="mx-4 max-w-4xl space-y-6 p-4 md:p-4">
      ...
      <div class="space-y-1">
        ...
        <p class="text-sm text-foreground/60 text-muted-foreground">Perbarui informasi Point of Presence (POP) yang sudah ada.</p>
      </div>
        ...
        <Card class="border shadow-none">
          ...
          <CardContent class="space-y-5">
            <div class="space-y-1.5">
              ...
              <!-- Existing Photos -->
              <div v-if="pop.photos && pop.photos.length > 0" class="mb-4 grid grid-cols-3 gap-4 md:grid-cols-4">
                <div
              ...
              <Label class="text-xs tracking-wider text-muted-foreground uppercase">Tambah Foto Baru</Label>
