    ...
    <AppLayout :breadcrumbs="[
        ...
        <div class="max-w-4xl mx-4 p-4 md:p-4 space-y-6">
            ...
            <div class="space-y-1">
                ...
                <p class="text-muted-foreground text-sm text-foreground/60">Perbarui informasi Point of Presence (POP) yang sudah ada.</p>
            </div>
                ...
                <Card class="border shadow-none">
                    ...
                    <CardContent class="space-y-5">
                        <div class="space-y-1.5">
                            ...
                            <!-- Existing Photos -->
                            <div v-if="pop.photos && pop.photos.length > 0" class="grid grid-cols-3 md:grid-cols-4 gap-4 mb-4">
                                <div v-for="photo in pop.photos" :key="photo.id" class="aspect-square rounded-lg overflow-hidden border border-slate-100 shadow-sm relative group">
                            ...
                            <Label class="text-xs text-muted-foreground uppercase tracking-wider">Tambah Foto Baru</Label>
