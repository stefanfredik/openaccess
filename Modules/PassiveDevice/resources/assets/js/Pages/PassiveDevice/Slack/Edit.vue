<script setup lang="ts">
  ...
  const submit = () => {
    form.put(route('passive-device.slack.update', props.slack.id))
  }
</script>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Update details for {{ slack.name }}. </CardDescription>
          </CardHeader>
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 border-t p-6">
            <Button variant="outline" as-child>
              <Link :href="route('passive-device.slack.index')">Cancel</Link>
            </Button>
