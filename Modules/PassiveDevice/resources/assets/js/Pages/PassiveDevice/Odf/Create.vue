  ...
  <AppLayout
    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-2xl font-bold tracking-tight">Add ODF</h1>
          <p class="text-muted-foreground">Register a new Optical Distribution Frame device.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Basic details and specifications of the ODF. </CardDescription>
          </CardHeader>
