            ...
            <form @submit.prevent="submit">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Basic details and specifications of the ODP.
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="grid gap-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="code" v-model="form.code" :class="{ 'border-destructive': form.errors.code }" placeholder="ODP-XYZ" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" :class="{ 'border-destructive': form.errors.name }" placeholder="ODP Box 1" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="splitter_type" v-model="form.splitter_type" :class="{ 'border-destructive': form.errors.splitter_type }" placeholder="1:8, 1:16, etc." />
