...
const form = useForm({
    infrastructure_area_id:
        props.splicingPoint.infrastructure_area_id.toString(),
...
const submit = () => {
    form.put(
        route('passive-device.splicing-point.update', props.splicingPoint.id),
    );
};
</script>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">
                        Update fiber splicing point details.
                    </p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select v-model="form.joint_box_id">
                                    ...
                                    >
                                        <SelectValue
                                            placeholder="Select Joint Box"
                                        />
                                    </SelectTrigger>
                                    <SelectContent>
                                        <SelectItem
                                            v-for="jb in jointBoxes"
                                            :key="jb.id"
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <Select v-model="form.splicing_type">
                                    ...
                                    <SelectContent>
                                        <SelectItem value="Core-Core"
                                            >Core-Core</SelectItem
                                        >
                                        <SelectItem value="Pigtail-Core"
                                            >Pigtail-Core</SelectItem
                                        >
                                        <SelectItem value="Splitter-Core"
                                            >Splitter-Core</SelectItem
                                        >
                                    </SelectContent>
                                </Select>
                            </div>
