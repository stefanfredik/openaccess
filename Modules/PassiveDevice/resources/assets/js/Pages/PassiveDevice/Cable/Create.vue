        ...
        <div class="flex flex-col gap-6 p-4 md:p-6 lg:p-8 max-w-4xl mx-auto">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">Register a new Fiber Optic Cable asset.</p>
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardContent class="grid gap-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="code" v-model="form.code" :class="{ 'border-destructive': form.errors.code }" placeholder="CABLE-XYZ" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" :class="{ 'border-destructive': form.errors.name }" placeholder="Core Backbone Jl. Merdeka" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="space-y-2">
                                ...
                                <Input id="type" v-model="form.type" :class="{ 'border-destructive': form.errors.type }" placeholder="ADSS, FIG8, etc." />
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="core_count" type="number" v-model="form.core_count" :class="{ 'border-destructive': form.errors.core_count }" />
                                <p v-if="form.errors.core_count" class="text-sm text-destructive">{{ form.errors.core_count }}</p>
                            </div>
                        </div>
                    ...
                    <CardFooter class="flex justify-end gap-2 border-t p-6 mt-6">
                        <Button variant="outline" as-child>
                            <Link :href="cableIndex().url">Cancel</Link>
                        </Button>
