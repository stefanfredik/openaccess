...
const submit = () => {
    form.put(route('passive-device.joint-box.update', props.jointBox.id));
};
</script>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">
                        Update Splice Enclosure asset details.
                    </p>
                </div>
            </div>
