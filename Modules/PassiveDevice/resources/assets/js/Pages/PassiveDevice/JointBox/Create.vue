            ...
            <form @submit.prevent="submit">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Capacity and technical details of the splice enclosure.
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="grid gap-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <Input id="code" v-model="form.code" :class="{ 'border-destructive': form.errors.code }" placeholder="JB-XYZ" />
                        ...
                        <div class="space-y-2">
                            ...
                            <Input id="name" v-model="form.name" :class="{ 'border-destructive': form.errors.name }" placeholder="Joint Box Intersection" />
