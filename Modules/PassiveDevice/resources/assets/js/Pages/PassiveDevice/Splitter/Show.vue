      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
              ...
              <div class="sm:col-span-2">
                ...
                <dd class="mt-1 text-sm">
                  {{ splitter.description || 'No description provided.' }}
                </dd>
              </div>
            </dl>
          </CardContent>
        ...
        <div class="space-y-6">
          <Card>
            ...
            <CardContent>
              <div v-if="splitter.photo" class="relative aspect-square overflow-hidden rounded-md bg-muted">
                <img :src="splitter.photo" :alt="splitter.name" class="h-full w-full object-cover" />
              </div>
              <div
                v-else
