<script setup lang="ts">
  ...
  const submit = () => {
    form.post(route('passive-device.splitter.store'))
  }
</script>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Ratio and loss specifications of the optical splitter. </CardDescription>
          </CardHeader>
