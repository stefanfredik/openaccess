    ...
    <div class="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6 lg:p-8">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-muted-foreground">Register a new Pole infrastructure asset.</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Physical characteristics and location data. </CardDescription>
          </CardHeader>
          <CardContent class="grid gap-6">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <div class="space-y-2">
                ...
                <Select v-model="form.material">
                  <SelectTrigger
                    :class="{
                      'border-destructive': form.errors.material,
                    }">
                ...
                <p v-if="form.errors.material" class="text-sm text-destructive">
            ...
            <div class="space-y-2">
              <Label for="pole_number">Pole Number (PLN/Provider)</Label>
              <Input
                id="pole_number"
                v-model="form.pole_number"
                :class="{
                  'border-destructive': form.errors.pole_number,
                }" />
              <p v-if="form.errors.pole_number" class="text-sm text-destructive">
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 border-t p-6">
            <Button variant="outline" as-child>
              <Link :href="route('passive-device.pole.index')">Cancel</Link>
            </Button>
