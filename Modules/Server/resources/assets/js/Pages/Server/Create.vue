  ...
  <AppLayout
    ...
    <div class="mx-4 max-w-4xl space-y-6 p-4 md:p-4">
      ...
      <div class="space-y-1">
        ...
        <p class="text-sm text-foreground/60 text-muted-foreground">Lengkapi informasi untuk mendaftarkan server atau perangkat core baru.</p>
      </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div class="space-y-2">
                ...
                <FileUploader
                  ...
                  accept="image/png, image/jpeg, image/jpg"
                  :max-size="5"
                  :error="(form.errors as any)['photos.Installation']" />
              </div>
              <div class="space-y-2">
                ...
                <FileUploader
                  ...
                  accept="image/png, image/jpeg, image/jpg"
                  :max-size="5"
                  :error="(form.errors as any)['photos.Cabling']" />
              </div>
            </div>
