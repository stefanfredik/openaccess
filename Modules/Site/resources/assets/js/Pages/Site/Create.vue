...
import { index as siteIndex, store as siteStore } from '@/routes/site';
        ...
        <div class="max-w-2xl mx-auto p-4 md:p-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Add a new physical site.</CardDescription>
                </CardHeader>
                <form @submit.prevent="submit">
                    ...
                    <CardFooter class="flex justify-between">
                        ...
                        <Button type="submit" :disabled="form.processing">Create Site</Button>
                    </CardFooter>
                </form>
            </Card>
        </div>
