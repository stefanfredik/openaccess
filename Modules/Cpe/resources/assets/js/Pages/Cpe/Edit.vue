      ...
      <form @submit.prevent="submit">
        <Card>
          <CardHeader>
            ...
            <CardDescription> Update equipment identification and customer details. </CardDescription>
          </CardHeader>
          ...
          <CardFooter class="mt-6 flex justify-end gap-2 rounded-b-lg border-t p-6">
