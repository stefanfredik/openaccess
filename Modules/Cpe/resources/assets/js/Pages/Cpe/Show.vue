        ...
        <div class="flex flex-col gap-6 p-4 md:p-6 lg:p-8 w-full">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight">{{ cpe.name }}</h1>
                        <p class="text-muted-foreground">Detail information for CPE {{ cpe.code }}</p>
                    </div>
                </div>
                <Button as-child>
            ...
            <div class="flex flex-col gap-6">
                <div class="grid gap-6 md:grid-cols-2">
                    <Card>
                        ...
                        <CardContent class="grid gap-4">
                            ...
                            <div class="grid grid-cols-2 gap-1">
                                <span class="text-sm font-medium text-muted-foreground">Installed At</span>
                    ...
                    <Card>
                        ...
                        <CardContent class="grid gap-4">
                            ...
                            <div class="grid grid-cols-2 gap-1">
                                <span class="text-sm font-medium text-muted-foreground">Serial Number</span>
                                <span>{{ cpe.serial_number || '-' }}</span>
                            </div>
                            <div class="grid grid-cols-2 gap-1">
                                <span class="text-sm font-medium text-muted-foreground">MAC Address</span>
                ...
                <Card>
                    ...
                    <CardContent>
                        <p class="whitespace-pre-wrap">{{ cpe.description || 'No description provided.' }}</p>
                    </CardContent>
                </Card>
